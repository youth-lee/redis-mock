...
9. Next BY AI
10. version **0.3.6** Geospatial (`GEO*`), and extended **Set / List / String / Hash** commands (see *Supported commands* below).
...
HashOperation
>  HDEL, HEXISTS, HGET, HGETALL, HINCRBY, HINCRBYFLOAT, HKEYS, HLEN, HMGET, HMSET, HSCAN, HSET, HSETNX, HVALS, HRANDFIELD<0.3.6+>, HSTRLEN<0.3.6+>, 
...
ListOperation
>  BLPOP, BRPOP, LINDEX, LINSERT, LLEN, LMOVE<0.3.6+>, LPOP, LPOS<0.3.6+>, LPUSH, LPUSHX, LRANGE, LREM, LSET, LTRIM, RPOP, RPOPLPUSH, RPUSH, RPUSHX, 
...
SetOperation
>  SADD, SCARD, SDIFF, SDIFFSTORE, SINTER, SINTERCARD<0.3.6+>, SINTERSTORE, SISMEMBER, SMEMBERS, SMISMEMBER<0.3.6+>, SMOVE, SPOP, SRANDMEMBER, SREM, SSCAN, SUNION, SUNIONSTORE, 
...
StringOperation
>  APPEND, BITCOUNT, BITOP, DECR, DECRBY, GET, GETBIT, GETDEL<0.3.6+>, GETEX<0.3.6+>, GETRANGE, GETSET, INCR, INCRBY, INCRBYFLOAT, MGET, MSET, MSETNX, PSETEX, SET, SETBIT, SETEX, SETNX, SETRANGE, STRLEN, SUBSTR<0.3.6+>, 

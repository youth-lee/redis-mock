...
9. Next BY AI
10. version **0.3.5** Geospatial (`GEO*`), and extended **Set / List / String / Hash** commands (see *Supported commands* below).
...
HashOperation
>  HDEL, HEXISTS, HGET, HGETALL, HINCRBY, HINCRBYFLOAT, HKEYS, HLEN, HMGET, HMSET, HSCAN, HSET, HSETNX, HVALS, HRANDFIELD<0.3.5+>, HSTRLEN<0.3.5+>, 

GeoOperation `<0.3.5+>`
>  GEOADD, GEODIST, GEOHASH, GEOPOS, GEORADIUS, GEORADIUSBYMEMBER, GEORADIUS_RO, GEORADIUSBYMEMBER_RO, 
...
ListOperation
>  BLPOP, BRPOP, LINDEX, LINSERT, LLEN, LMOVE<0.3.5+>, LPOP, LPOS<0.3.5+>, LPUSH, LPUSHX, LRANGE, LREM, LSET, LTRIM, RPOP, RPOPLPUSH, RPUSH, RPUSHX, 
...
ServerOperation
>  DBSIZE, FLUSHALL<ASYNC, 4.0.0+>, FLUSHDB<ASYNC, 4.0.0+>, TIME, 0.0.2+, CLIENT GETNAME, CLIENT ID<0.3.4+>, CLIENT KILL, CLIENT LIST, CLIENT SETNAME,CLIENT SETINFO<0.3.4+>, CLIENT INFO<0.3.4+>,

SetOperation
>  SADD, SCARD, SDIFF, SDIFFSTORE, SINTER, SINTERCARD<0.3.5+>, SINTERSTORE, SISMEMBER, SMEMBERS, SMISMEMBER<0.3.5+>, SMOVE, SPOP, SRANDMEMBER, SREM, SSCAN, SUNION, SUNIONSTORE, 
...
StringOperation
>  APPEND, BITCOUNT, BITOP, DECR, DECRBY, GET, GETBIT, GETDEL<0.3.5+>, GETEX<0.3.5+>, GETRANGE, GETSET, INCR, INCRBY, INCRBYFLOAT, MGET, MSET, MSETNX, PSETEX, SET, SETBIT, SETEX, SETNX, SETRANGE, STRLEN, SUBSTR<0.3.5+>, 
